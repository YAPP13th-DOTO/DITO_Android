...
import com.team_yapp.kiyon.yappproject.view.RoomDetailActivity;
...
import com.team_yapp.kiyon.yappproject.view.RoomStatisticsActivity;
...
public class RoomListRVAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private class RoomListProgressVH extends RecyclerView.ViewHolder {
        ...
        public RoomListProgressVH(final View itemView) {
            ...
            profile_image1 = itemView.findViewById(com.team_yapp.kiyon.yappproject.R.id.profile_image1);
